...
def getargs():
        ...
        """
        parser = argparse.ArgumentParser(description = "calculate median",
                                        epilog=examplelog,
                                        add_help=False)
        ...
        #parser.add_argument('-df2', "--diff2",type=float, default=0.1, help = "the threshold of case_median - control_median")
...
def cal(file,a,b):
	...
	with open(file) as fh:
		for lines in fh:
			...
			diff2 = case_median - con_median
			all.append([id,case_median,con_median, diff2])
...
if __name__ == "__main__":
	...
	fw1.write('chr\tstart\tend\tcancer_median\thealth_median\tmedian_diff\n')
	#fw2.write('chr\tstart\tend\tcase_average\tcon_average\tcase_sd\tcon_sd\tFoldChange\tpvalue\tmedian_diff\n')
